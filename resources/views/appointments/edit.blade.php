<x-app-layout>
    ...
    @foreach(['Masaje Terapeutico', 'Masaje relajante', 'Masaje combinado', 'Masaje dreno linfatico', 'Masaje de descarga o deportivo', 'Masaje craneofacial', 'Masaje de reflexologia podal', 'Masaje piernas cansadas', 'Masaje terapeutico cuppin', 'Masaje relajante con piedras calientes', 'Masaje terapeutico con termoterapia', 'Masaje reductivo', 'Maderoterapia con drenolinfático', 'Facial Hidratante', 'Limpieza facial', 'Exfoliacion corporal', 'Depilalcion laser', 'Paquete 1 individual', 'Paquete 2 individual', 'Paquete 1 pareja', 'Paquete 2 pareja', 'Paquete de masaje', 'Paquete de depilación', 'Reflexologia de manos'] as $srv)
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="payment_method" id="payment_method" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">
                                ...
                                <option value="Tarjeta de Regalo" {{ old('payment_method', $appointment->payment_method) == 'Tarjeta de Regalo' ? 'selected' : '' }}>Tarjeta de Regalo</option>
                            </select>
